...
**GPipe**（Huang et al., 2019）通过将 batch 切分为多个**微批次**（micro-batch）来填充气泡：
...
**PipeDream** 提出了 **1F1B**（One Forward One Backward）调度：
