...
$\mathbf{Q}_i$ 需要与**所有** $\mathbf{K}, \mathbf{V}$ 交互，不能简单切分。这就像读小说时，第 50 章的内容可能需要参考前 49 章任何地方的线索——你不能完全独立地读某一章，必须能访问之前所有内容。
...
Ring Attention 的精髓在于重叠——当你在读当前收到的笔记时，下一份笔记已经在传递的路上了：
