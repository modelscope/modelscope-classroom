...
视觉生成模型在图像和视频生成领域取得了显著进展。从Stable Diffusion到Flux，从静态图像到动态视频，视觉生成能力不断提升。

## 图像生成模型

### Stable Diffusion系列

Stable Diffusion是最具影响力的开源图像生成模型。
...
视觉生成模型生态正在快速发展，从静态图像到动态视频，从单一生成到多模态融合，应用场景不断拓展。选择合适的模型并掌握有效的使用技巧，可以显著提升创作效率与质量。
