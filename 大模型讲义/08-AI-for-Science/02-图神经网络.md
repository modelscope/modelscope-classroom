...
想象一下你小区的社交网络：每个人是一个节点，两个人之间的友谊是一条边。有的人朋友多，有的人朋友少；有的人圆子重叠，有的人各自独立——这种不规则的连接模式正是图结构的特征。传统的深度学习工具就像拿着一把果刺“尺子”来量一棵树的枝条走向——工具不对。
...
GCN的优势在于简洁高效，但其聚合权重完全由图结构决定，缺乏对不同邻居重要性的区分。回到社交网络的场景：GCN 等于让你的每个邻居说话的音量一样大，而不管对方是一位村里老老还是一个刚搬来的陌生人。显然这不够智能。
