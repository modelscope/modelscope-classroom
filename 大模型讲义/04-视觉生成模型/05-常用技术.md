...
假设你去餐厅点菜，告诉庞师"我要麻辣口味"。如果庞师只是模糊地听了一下，可能端上来一盘微微有点辣的家常菜——安全但不过瘾。而分类器引导的作用，就是在旁边安排一位美食评委，每做一步都提醒庞师："再麻一点！再辣一点！"——把生成结果往条件要求的方向使劲推。
...
想象一下你告诉庞师："我要麻辣口味，但绝对不要放香菜"。正向提示词告诉模型想要什么，负向提示词告诉模型绝对不要什么。两者配合使用，可以更精确地控制生成结果。在实践中，很多用户发现合理的负向提示词对图像质量的提升甚至超过了调节 $w$ 值。
