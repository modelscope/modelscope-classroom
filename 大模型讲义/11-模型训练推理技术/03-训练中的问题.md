...
**解决方案**：应对梯度消失的核心思想是给梯度提供"捷径"，让它不必经过每一层的"衔减"就能直接传到早期层：
...
训练问题的诊断需要系统性的方法：监控关键指标、理解问题根因、选择合适的解决方案。就像一位经验丰富的厨师能从菜肉的颜色、气味和声音判断烹饪状态一样，随着对这些问题的理解加深，你会逐渐培养出“看一眼训练曲线就知道哪里出了问题”的直觉。
